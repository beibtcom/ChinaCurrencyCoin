...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ChinaCurrencyCoins"));
    case mBTC: return QString(QObject::tr("Milli-ChinaCurrencyCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ChinaCurrencyCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
