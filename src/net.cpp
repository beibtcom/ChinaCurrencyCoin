...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-net");
...
static const char *strDNSSeed[][2] = {
    {"seed.chinacurrencycoin.com", "seed.chinacurrencycoin.com"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("ChinaCurrencyCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ChinaCurrencyCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("ChinaCurrencyCoin-start");
